...
IMPULSE_LOOKBACK = 14
MAX_IMPULSE_AGE = 7
MAX_IMPULSE_TOTAL_ATR = 3.40
MAX_CONSECUTIVE_DIRECTION_CANDLES = 7
MIN_IMPULSE_BODY_RATIO = 0.65
MIN_IMPULSE_BODY_ATR = 0.55
BREAKOUT_LOOKBACK = 7
...
INDECISION_MAX_BODY_RATIO = 0.50
INDECISION_MIN_WICK_RATIO = 0.50

REST_MAX_BODY_RATIO = 0.70
REST_MIN_PREVIOUS_BODY_RATIO = 0.75

CONTINUITY_MIN_BODY_RATIO = 0.50
CONTINUITY_MIN_BODY_ATR = 0.40
...
def analyze_market(
    ...
    if structure == "bullish":
        ...
        # La señal estructural principal requiere rechazo
        # o una continuidad extremadamente clara.
        valid_pattern = (
            rejection
            or continuity
            or rest
        ...
        if not valid_pattern:
            result["reason"] = (
                "Sin patrón de alta confluencia"
            )
            return result

        # Si es indecisión, N no dispara por sí sola.
        # Se exige contexto fuerte de rechazo/estructura.
        if indecision and not (
            rejection
            or divergence["bullish"]
        ):
            result["reason"] = (
                "Indecisión sin confirmación estructural suficiente"
            )
            return result
        ...
        result.update({
            ...
            "reason": (
                ...
                f"probabilidad={probability}/100 | "
                f"calidad={quality}/100 | "
                "rechazo/estructura/impulso confirmados"
            ),
            "continuity": True,
            "blocked": False,
            "zone": (
